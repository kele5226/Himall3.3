...
namespace Himall.IServices
{
    public interface IWXMsgTemplateService : IService
    {
        ...
        /// </summary>
        /// <returns></returns>
        Entities.WeiXinMsgTemplateInfo GetWeiXinMsgTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type);
        /// <summary>
        /// 设置微信模板消息配置
        /// </summary>
        /// <param name="info"></param>
        ...
        /// </summary>
        /// <returns></returns>
        Entities.WeiXinMsgTemplateInfo GetWXAppletMsgTemplate(Himall.Core.Plugins.Message.MessageTypeEnum type);
