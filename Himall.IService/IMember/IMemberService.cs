...
namespace Himall.IServices
{
    public interface IMemberService : IService
    {
        ...
        void CheckContactInfoHasBeenUsed(string serviceProvider, string contact, Himall.Entities.MemberContactInfo.UserTypes userType = Himall.Entities.MemberContactInfo.UserTypes.General);
