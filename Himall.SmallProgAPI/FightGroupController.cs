    ...
    public class FightGroupController : BaseApiController
    {
        ...
        public JsonResult<Result<dynamic>> GetFightGroupOrderByUser(int pageSize = 5, int pageNo = 1)
        {
            ...
            foreach (var item in datalist)
            {
                ...
                _tmp.ProductDefaultImage = HimallIO.GetRomoteProductSizeImage(item.ProductImgPath, 1, (int)ImageSize.Size_350);
            ...
            return JsonResult<dynamic>(new { rows = resultlist, total = data.Total });
        }
