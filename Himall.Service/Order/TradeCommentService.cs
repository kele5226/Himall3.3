...
namespace Himall.Service
{
    public class TradeCommentService : ServiceBase, ITradeCommentService
    {
        ...
        public void AddOrderComment(OrderCommentInfo info, int productNum)
        {
            ...
            var memberIntegral = ServiceProvider.Instance<IMemberIntegralConversionFactoryService>.Create.Create(Himall.Entities.MemberIntegralInfo.IntegralType.Comment);
