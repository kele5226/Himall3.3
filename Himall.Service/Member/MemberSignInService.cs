...
namespace Himall.Service
{
    ...
    public class MemberSignInService : ServiceBase, IMemberSignInService
    {
        ...
        private void AddIntegralToUser(long memberId, int integral, bool isReward)
        {
            ...
            var memberIntegral = ServiceProvider.Instance<IMemberIntegralConversionFactoryService>.Create.Create(Himall.Entities.MemberIntegralInfo.IntegralType.SignIn, integral);
