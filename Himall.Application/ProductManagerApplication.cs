...
namespace Himall.Application
{
    ...
    {
        private static IProductDescriptionTemplateService _productDescriptionTemplateService = ObjectContainer.Current.Resolve<IProductDescriptionTemplateService>();
        private static ISearchProductService _searchProductService = ObjectContainer.Current.Resolve<ISearchProductService>();
        private static IProductLadderPriceService _productLadderPriceService = ObjectContainer.Current.Resolve<IProductLadderPriceService>();
