...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class TemplateVisualizationAjaxController : BaseSellerController
    {
        ...
        private void InitialBonusContentModel(IEnumerable<Himall.Entities.BonusInfo> bonusList, BonusAjaxModel model)
        {
        ...
        private void InitialCouponsContentModel(IEnumerable<Himall.Entities.CouponInfo> couponsList, CouponsAjaxModel model)
        {
