...
ALTER TABLE Himall_ApplyWithDraw MODIFY COLUMN NickName varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;	-- 微信昵称
...
ALTER TABLE Himall_Member MODIFY COLUMN Nick varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;		-- 微信昵称
ALTER TABLE Himall_Member MODIFY COLUMN RealName varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;	-- 在获取优惠券等地方一键登录昵称给用户真实姓名字段
...
ALTER TABLE Himall_ProductComment MODIFY COLUMN AppendContent varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;-- 评论特殊表情符
ALTER TABLE Himall_ProductComment MODIFY COLUMN ReviewContent varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE `himall_shop` MODIFY COLUMN `WeiXinNickName`  varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; -- 商家提现微信绑定特殊表情符编码设置；
-- ----------------------------
